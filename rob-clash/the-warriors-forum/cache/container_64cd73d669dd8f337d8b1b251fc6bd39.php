...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'spaceace.ajaxchat.archive.controller' => 'getSpaceace_Ajaxchat_Archive_ControllerService',
            'spaceace.ajaxchat.chat.controller' => 'getSpaceace_Ajaxchat_Chat_ControllerService',
            'spaceace.ajaxchat.cron.task.prune_ajaxchat' => 'getSpaceace_Ajaxchat_Cron_Task_PruneAjaxchatService',
            'spaceace.ajaxchat.listener' => 'getSpaceace_Ajaxchat_ListenerService',
            'spaceace.ajaxchat.popup.controller' => 'getSpaceace_Ajaxchat_Popup_ControllerService',
    ...
    protected function getCron_TaskCollectionService()
    {
        ...
        $instance->add('spaceace.ajaxchat.cron.task.prune_ajaxchat');
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('mysql.hostinger.com.br', 'u966545589_root', '258369.,', 'u966545589_forum', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('spaceace.ajaxchat.listener', 'spaceace\\ajaxchat\\event\\listener');
    ...
    /**
     * Gets the 'spaceace.ajaxchat.archive.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \spaceace\ajaxchat\controller\chat A spaceace\ajaxchat\controller\chat instance.
     */
    protected function getSpaceace_Ajaxchat_Archive_ControllerService()
    {
        return $this->services['spaceace.ajaxchat.archive.controller'] = new \spaceace\ajaxchat\controller\chat($this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('controller.helper'), $this->get('config'), $this->get('ext.manager'), $this->get('path_helper'), $this, 'phpbb_', './../', 'php');
    }

    /**
     * Gets the 'spaceace.ajaxchat.chat.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \spaceace\ajaxchat\controller\chat A spaceace\ajaxchat\controller\chat instance.
     */
    protected function getSpaceace_Ajaxchat_Chat_ControllerService()
    {
        return $this->services['spaceace.ajaxchat.chat.controller'] = new \spaceace\ajaxchat\controller\chat($this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('controller.helper'), $this->get('config'), $this->get('ext.manager'), $this->get('path_helper'), $this, 'phpbb_', './../', 'php');
    }

    /**
     * Gets the 'spaceace.ajaxchat.cron.task.prune_ajaxchat' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \spaceace\ajaxchat\cron\task\prune_ajaxchat A spaceace\ajaxchat\cron\task\prune_ajaxchat instance.
     */
    protected function getSpaceace_Ajaxchat_Cron_Task_PruneAjaxchatService()
    {
        $this->services['spaceace.ajaxchat.cron.task.prune_ajaxchat'] = $instance = new \spaceace\ajaxchat\cron\task\prune_ajaxchat($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('log'), 'phpbb_');

        $instance->set_name('cron.task.prune_ajaxchat');

        return $instance;
    }

    /**
     * Gets the 'spaceace.ajaxchat.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \spaceace\ajaxchat\event\listener A spaceace\ajaxchat\event\listener instance.
     */
    protected function getSpaceace_Ajaxchat_ListenerService()
    {
        return $this->services['spaceace.ajaxchat.listener'] = new \spaceace\ajaxchat\event\listener($this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('controller.helper'), $this->get('config'), $this->get('config_text'), $this->get('ext.manager'), $this->get('path_helper'), $this, 'phpbb_', './../', 'php', $this->get('spaceace.ajaxchat.chat.controller'));
    }

    /**
     * Gets the 'spaceace.ajaxchat.popup.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \spaceace\ajaxchat\controller\chat A spaceace\ajaxchat\controller\chat instance.
     */
    protected function getSpaceace_Ajaxchat_Popup_ControllerService()
    {
        return $this->services['spaceace.ajaxchat.popup.controller'] = new \spaceace\ajaxchat\controller\chat($this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('auth'), $this->get('request'), $this->get('controller.helper'), $this->get('config'), $this->get('ext.manager'), $this->get('path_helper'), $this, 'phpbb_', './../', 'php');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbhost' => 'mysql.hostinger.com.br',
            'dbal.dbuser' => 'u966545589_root',
            'dbal.dbpasswd' => '258369.,',
            'dbal.dbname' => 'u966545589_forum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
