...
/* Dynamically add font icons to buttons */
jQuery(function($) {
	'use strict';
	$( ".button.reply-icon" ).prepend( "<span><i class='fa fa-reply'></i></span>&nbsp;" );
	$( ".button.post-icon" ).prepend( "<span><i class='fa fa-plus'></i></span>&nbsp;" );
	$( ".pmreply-icon" ).prepend( "<span><i class='fa fa-reply'></i></span>&nbsp;" );
	$( ".button.newpm-icon" ).prepend( "<span><i class='fa fa-plus'></i></span>&nbsp;" );
	$( ".button.reply-all" ).prepend( "<span><i class='fa fa-reply-all'></i></span>&nbsp;" );
	$( ".button.locked-icon" ).prepend( "<span><i class='fa fa-lock'></i></span>&nbsp;" );
	$( ".button.forwardpm-icon" ).prepend( "<span><i class='fa fa-share'></i></span>&nbsp;" );
});
